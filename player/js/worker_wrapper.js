function workerContent() {
    ...
    onmessage = function (evt) {
        ...
        if (type === "load") {
            ...
            if (animations[payload.id]) {
                animations[payload.id].animation.goToAndPlay(
                    payload.value,
                    payload.isFrame,
                );
            }
            ...
            if (animations[payload.id]) {
                animations[payload.id].animation.goToAndStop(
                    payload.value,
                    payload.isFrame,
                );
            }
            ...
            if (animations[payload.id]) {
                ...
                animations[payload.id].animation.addEventListener(
                    payload.eventName,
                    eventCallback,
                );
            }
            ...
            if (animations[payload.id]) {
                var callback =
                    animations[payload.id].events[payload.callbackId];
                animations[payload.id].animation.removeEventListener(
                    payload.eventName,
                    callback,
                );
            }
            ...
            if (animations[payload.id]) {
                animations[payload.id].animation.playSegments(
                    payload.arr,
                    payload.forceFlag,
                );
            }
            ...
            if (animations[payload.id]) {
                animations[payload.id].animation.resetSegments(
                    payload.forceFlag,
                );
            }
        } else if (type === "updateDocumentData") {
            animations[payload.id].animation.updateDocumentData(
                payload.path,
